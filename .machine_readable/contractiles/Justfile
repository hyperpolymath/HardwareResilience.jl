...
# Justfile for HardwareResilience.jl
...
doctor:
    @echo "Running diagnostics for HardwareResilience.jl..."
...
tour:
    @echo "=== HardwareResilience.jl Tour ==="
    @echo ""
...
help-me:
    @echo "=== HardwareResilience.jl Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/HardwareResilience.jl/issues/new"
    @echo ""
...
# LLM context dump
llm-context:
    @echo "Project: HardwareResilience.jl"
